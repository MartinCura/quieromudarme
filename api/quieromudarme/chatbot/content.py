...
{MSG_SEPARATOR}
🔎 Este bot es perfecto si ya venís buscando y querés que te avisemos **cuando hay algo nuevo o algo baja de precio**, y solo necesitás el link 🔗 que está en la barrita del navegador.

Lo único que tenés que hacer es copiar tu búsqueda acá y listo! 🎉
...
👉 Desde las apps no podés copiar el link 🔗, así que para crear las búsquedas necesitás una compu.
...
"""
HELP_MSGS: Final = [msg.strip() for msg in HELP.split(MSG_SEPARATOR)]
